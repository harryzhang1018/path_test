...
state_v06 = genfromtxt('/home/harry/Documents/path_test/state_e1_v06.csv', delimiter=',')
state_v08 = genfromtxt('/home/harry/Documents/path_test/state_e1_v08.csv', delimiter=',')
state = genfromtxt('/home/harry/Documents/path_test/state_e1.csv', delimiter=',')
state_v12 = genfromtxt('/home/harry/Documents/path_test/state_e1_v12.csv', delimiter=',')
state_v14 = genfromtxt('/home/harry/Documents/path_test/state_e1_v14.csv', delimiter=',')
state_v16 = genfromtxt('/home/harry/Documents/path_test/state_e1_v16.csv', delimiter=',')
# cone_r_x = data[:,0]
# cone_r_y = data[:,1]
cone_l_x = cone_pos[:,2]
cone_l_y = cone_pos[:,3]
...
plt.plot(state_x,state_y,label="v=1 m/s")
